...
<div class="home-header-container">
  ...
  <img src="../TusharDagar/public/Images/header.png" alt="RAMT items image">
...
<section id="homesection1">
  <div id="h2Title">
    <h2>We guarantee to provice you fresh items with best price!</h2>
  </div>
  ...
  <div id="homeitem2">
    <div id="imageContainer">
      ...
      <img src="../TusharDagar/public/Images/coffeePlant.png" alt="RAMT items image">
    </div>
  </div>
  ...
  <div id="homeitem1">
    ...
    <p>
      ...
      selection
      of high-quality coffee, accessories. From farm-fresh coffee and best accessories, we've got everything you need to fill your basket without emptying
      your
      wallet."
